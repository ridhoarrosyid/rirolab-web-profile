              ...
              <div className="space-y-8">
                <div className="group flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed text-gray-600">
                      Calon klien ragu mengambil keputusan bernilai besar karena
                      bisnis tidak memiliki representasi digital yang
                      meyakinkan.
                    </p>
                  </div>
                </div>
                ...
                <div className="group flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed text-gray-600">
                      Pengunjung website tidak berujung pada pengisian form atau
                      kontak ke sales (conversion rate sangat rendah).
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div className="group flex h-full cursor-pointer flex-col rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="mb-8 flex-grow leading-relaxed text-gray-600">
                ...
                spesifik: mengubah pengunjung menjadi leads berkualitas tinggi.
              </p>
            ...
            <div className="group flex h-full cursor-pointer flex-col rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="mb-8 flex-grow leading-relaxed text-gray-600">
                Representasi digital komprehensif yang memperkuat visi, values,
                dan kapabilitas perusahaan di mata stakeholder.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="text-gray-600">
              Melihat bagaimana kami membantu bisnis B2B dan konstruksi menonjol
              di pasar dengan kehadiran digital yang memukau.
            </p>
          </div>
