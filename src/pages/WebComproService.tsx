...
import damarianWebProfile from "../assets/images/damarian.webp";
...
const features = [
  ...
  },
  {
    ...
    title: "Proses Pengerjaan Cepat",
    desc: "Sistem kerja efisien kami memungkinkan peluncuran identitas digital perusahaan Anda dalam hitungan minggu, bukan bulan.",
  },
  {
    icon: <Settings className="text-blue-950" size={28} />,
    title: "Desain Representatif",
    desc: "Arsitektur visual yang disesuaikan untuk menonjolkan karakter, visi, dan layanan spesifik dari UMKM Anda kepada publik.",
  },
];
...
const lpPricing = [
  ...
  },
  {
    ...
    features: [
      ...
      "5-8 Halaman (Home, About, Services, dsb.)",
      "Design Premium / Clean",
      "2 Email Bisnis Resmi",
  ...
  },
  {
    ...
    features: [
      ...
      "Up to 12 Halaman Bebas (Portfolio, Karir, Blog, dll)",
      "Request Fitur Khusus (Katalog, Animasi, Multi-bahasa)",
      "Desain Premium (Parallax, Custom Layout)",
      "Speed Optimization (Lazy Load + Caching)",
      "5x Revisi Gratis",
...
const faqs = [
  {
    ...
    a: "Untuk paket Starter Profile rata-rata 4-6 hari kerja, sedangkan paket Business sekitar 1-2 minggu kerja tergantung antrean dan kelengkapan materi perusahaan (logo, foto, teks).",
  },
  {
    q: "Apakah sudah termasuk domain dan hosting?",
    a: "Ya, semua paket sudah termasuk nama Domain profesional (.com) dan Hosting di tahun pertama pengerjaan.",
  },
  {
    q: "Bisakah saya mengubah informasi perusahaan setelah jadi?",
    a: "Tentu, kami menyediakan kuota revisi sesuai paket yang dipilih. Untuk perubahan mayor setelah serah terima akan dikenakan biaya maintenance terpisah.",
  },
  {
    q: "Apakah company profile bisa diakses dengan baik di HP?",
    a: "Wajib. Semua website buatan Damarian Biznis menggunakan pendekatan Mobile-First agar tampil sempurna dan profesional, baik di smartphone maupun desktop.",
  },
];
...
const portfolio = [
  ...
  {
    image: damarianWebProfile,
    caption: "Damarian - Toko Oleh Oleh",
    link: "https://damarianoleholeh.com",
  },
  {
...
const testimonials = [
  {
    ...
    name: "Budi Santoso",
    testi:
      "Damarian Biznis benar-benar mengerti kebutuhan UMKM. Company profile kami sekarang terlihat jauh lebih kredibel, elegan, dan tingkat kepercayaan mitra saat tender meningkat signifikan.",
  ...
  },
  {
    ...
    name: "Andi Nugraha",
    testi:
      "Layanan yang luar biasa. Profil digital kami kini tampil sangat profesional dan tidak berat saat diakses. Sangat direkomendasikan bagi UMKM yang ingin naik kelas.",
...
export default function CompanyProfileService() {
  ...
  const handleWA = (
    ...
    const msg = `Halo Kak, saya tertarik dengan paket Website Company Profile ${pkgName && price ? `- ${pkgName} (${price})` : ""}. Bisa bantu jelaskan detailnya?`;
        ...
        <div className="grid grid-cols-1 items-center lg:grid-cols-5 lg:gap-12">
          <div className="animate-in fade-in slide-in-from-left-8 space-y-6 duration-700 md:space-y-8 lg:col-span-3">
            <h1 className="text-3xl leading-tight font-extrabold text-blue-950 sm:text-4xl md:text-5xl lg:text-6xl">
              Satu Website Company Profile Profesional, Ribuan Peluang Bisnis
              Baru.
            </h1>
            <p className="max-w-xl text-base leading-relaxed text-gray-600 md:text-lg">
              Kami membangun representasi digital yang kredibel untuk
              memenangkan kepercayaan pelanggan, menarik mitra strategis, dan
              memperkuat citra bisnis Anda di dunia maya.
            </p>
          ...
          <div className="group perspective relative col-span-2 mt-8 lg:mt-0">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 shadow-2xl">
              <img
                loading="eager"
                src={damarianWebProfile}
                className="h-auto w-full object-cover"
                alt="Gambar Website Company Profile"
              />
              {/* Trust Badge overlay */}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24 lg:px-8">
        <div className="mb-8 text-center md:mb-10">
          <h2 className="mb-4 text-2xl font-extrabold text-blue-950 sm:text-3xl md:text-4xl">
            Pilih Paket Company Profile Anda
          </h2>
          ...
          <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-blue-950 px-4 py-1.5 text-[10px] font-bold tracking-widest text-white uppercase shadow-md md:mt-12 md:text-xs">
            ...
            Sisa kuota pengerjaan bulan ini: 5 slot
          </div>
        </div>
          ...
          <div className="relative">
            ...
            <div className="mt-2 flex justify-center">
              <span className="flex animate-pulse items-center gap-2 text-xs font-medium text-gray-400 md:text-sm">
                &larr; Geser untuk melihat portofolio lainnya &rarr;
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[30px] bg-blue-950 p-8 text-center shadow-2xl md:rounded-[50px] md:p-12">
          ...
          <div className="relative z-10 flex flex-col items-center">
            <h2 className="mb-6 text-2xl leading-tight font-bold text-white sm:text-3xl md:mb-8 md:text-4xl lg:text-5xl">
              Jangan biarkan bisnis Anda terlihat tidak profesional.{" "}
